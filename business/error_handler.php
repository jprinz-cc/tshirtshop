...
class ErrorHandler
{
	...
	public static function Handler($errNo, $errStr, $errFile, $errLine){
		...
		/*Warnings don't abort execution if IS_WARNING_FATAL is fale E_NOTICE and 
		 E_USER_NOTICE errors don't abort execution*/
	...
	public static function GetBacktrace($irrelevantFirstEntries){
		...
		foreach ($trace_array as $arr){
			...
			if (!empty ($arr['args'])){
				...
				$line = (isset ($arr['file']) ? $arr['file']: 'unknown');
